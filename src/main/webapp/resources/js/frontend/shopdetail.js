		...
		$
			.getJSON(
				...
				function(data) {
					if (data.success) {
						var shop = data.shop;
						var lastEditDate = new Date(shop.lastEditTime).getFullYear() + "-" +
						new Date(shop.lastEditTime).getMonth() + "-"
						+ new Date(shop.lastEditTime).getDay();
	...
	$('.list-div')
		.on(
			...
			function(e) {
				...
				window.location.href = '/o2o/frontend/shopdetail?shopId='
					+ shopId;
			});
